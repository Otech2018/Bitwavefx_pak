                    ...
                    <div class="row footer-top-wrap">
                        <div class="col-md-4 col-sm-6">
                            <div class="footer-nav-wrap text-white">
                                <img src="images/logo-white.png" alt="BITWAVEFX" class="mb-2">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="footer-nav-wrap text-white">
                                ...
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="plans.php">Our Plans</a>
                                    </li>
                                </ul>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="footer-nav-wrap text-white">
                                ...
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="forgot_password.php">Password Recovery</a> 
                                    </li>
                                    <li class="nav-item">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-5 col-lg-5">
                    <p class="copyright-text pb-0 mb-0">Copyrights © 2021. All
                        rights reserved by
                        <a href="index.php">BITWAVEFX</a></p>
                </div>
                <div class="col-md-7 col-lg-6 d-none d-md-block d-lg-block">
                    <ul class="list-inline policy-nav text-right social-list">
                        <li class="list-inline-item"><a href="rules.php">Terms & Conditions</a></li>
                    </ul>
                </div>
            </div>
        </div>
