...
<!-- Mirrored from polyvorex.com/?a=forgot_password by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Jan 2021 13:52:09 GMT -->
            ...
            <div class="row align-items-center justify-content-between pt-5 pt-sm-5 pt-md-5 pt-lg-0">
                <div class="col-md-7 col-lg-6">
                    <div class="hero-content-left text-white">
                        ...
                        <p class="lead">
                            Type your username or email and you should receive reset password link.<br>
...
<form method=post name=forgotform onsubmit="return checkform();" class="login-signup-form"><input type="hidden" name="form_id" value="16102002452037"><input type="hidden" name="form_token" value="10329a02574b4cedf807586fe005d2da">
<input type=hidden name=a value="forgot_password">
<input type=hidden name=action value="forgot_password">
                                <div class="form-group">
                                    <label class="pb-1">Your username or email</label>
                                    <div class="input-group input-group-merge">
                                        <div class="input-icon">
                                            <span class="ti-user color-primary"></span>
                                        </div>
                                        <input type="text" name='email' value="" class="form-control" placeholder="Enter your username or email">
                                    </div>
                                </div>

                                <input type=submit value="Forgot" class="btn btn-block secondary-solid-btn border-radius mt-4 mb-3">
                            </form>
                                                    </div>
                    </div>
                </div>
...
<!-- Mirrored from polyvorex.com/?a=forgot_password by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Jan 2021 13:52:10 GMT -->
</html>
